...
<script src="{{URL::asset('assets/frontend/js/intlTelInput.min.js') }}"></script>
...
<p class="credit" style="color: #000000">Total money : @php echo($viewData['total']) @endphp $</p>
<div class="tab_container">
    <input id="tab1" type="radio" name="tabs" checked>
    <label for="tab1"><span class="numberCircle">1</span><span>Paypal checkout</span></label>

    <input id="tab2" type="radio" name="tabs">
    <label for="tab2"><span class="numberCircle">2</span><span>Paypal direct</span></label>

    <input id="tab3" type="radio" name="tabs" checked>
    <label for="tab3"><span class="numberCircle">3</span><span>Amex</span></label>

    <input id="tab4" type="radio" name="tabs" checked>
    <label for="tab4"><span class="numberCircle">4</span><span>Airwallex</span></label>

    <input id="tab5" type="radio" name="tabs" checked>
    <label for="tab5"><span class="numberCircle">5</span><span>Stripe</span></label>
    ...
    @include('Test.Gateway.paypaldirect')

    @include('Test.Gateway.amex')

    @include('Test.Gateway.airwallex')

    @include('Test.Gateway.stripe')
